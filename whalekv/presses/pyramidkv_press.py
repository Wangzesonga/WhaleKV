...
class PyramidKVPress(SnapKVPress):
    ...
    def get_layer_budget(
        ...
        Uses the budget calculation formula from:
        ...
        instead of disabling compression or keeping fixed budget for short queries
        like the original code.

        max_capacity_prompt is calculated as:
            max_num + min_num   = (max_capacity_prompt - window_size) * 2
            total_kvcache_size  = (max_num + min_num) * num_layers / 2
