...
from whalekv.utils import extract_keys_and_values
...
class BasePress:
    ...
    def forward_hook(self, module: nn.Module, input: list[torch.Tensor], kwargs: dict, output: list):
        ...
        input : list[torch.Tensor]
            Input tensors to the forward pass of the attention layer.
        kwargs : dict
        ...
        -------
        list
            The potentially modified output from the forward pass. The underlying cache
            has been compressed in-place.
        """
        ...
        # Skip compression when the sequence is too short for the press to operate
        min_len = getattr(self, "window_size", 1)
        if q_len <= min_len:
            return output
    ...
    def __call__(self, model: PreTrainedModel) -> Generator:
        ...
        Examples
        --------
        >>> from whalekv import SemanticDegreePress_V4_Atomic_KNN
