...
def patch_attention_functions():
    ...
    It enables WhaleKV compression methods that require head-specific masking
    to work correctly during text generation.
    ...
    whalekv to ensure compatibility with head-wise compression methods.

    Notes
    -----
    This function modifies the global attention functions in the transformers
    library. The modifications do not affect models that don't use head-wise compression.
    """
